...
```bash
node .agents/skills/run-desktop/driver.mjs
```
...
tmux send-keys -t qt 'cd /Users/alensam/Projects/QuickyTrade-gpt && node .agents/skills/run-desktop/driver.mjs' Enter
